...
- [x] Submitted 2026-09-06 through the ATS form (Recruitis): `Torrellas_Atahualpa.bundle` (history up to `0315d65`, tag v1.0.0) + `Torrellas_Atahualpa_project-guide.pdf`
